...
<div class="max-w-5xl mx-auto px-6">
    ...
    <div class="mb-8 text-center">
        <div class="inline-flex items-center gap-2 text-3xl font-semibold text-[#1b1b18]">
            <h1>Найденная книга</h1>
        </div>
        <p class="text-[#706f6c] mt-1">Просмотр информации и отзывов</p>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 lg:p-8">
            ...
            <div class="space-y-5">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <span class="inline-block px-5 py-1 bg-green-700 text-white rounded-full text-sm shadow-md">{{ $book->status }}</span>
                </div>
                ...
                {{-- Блок-примечание, что книга найдена --}}
                <div class="mt-4 p-3 bg-green-50 border border-green-200 text-green-800 rounded-xl text-sm text-center">
    ...
    <div class="bg-white border border-[#e3e3e0] rounded-3xl shadow-sm overflow-hidden">
        <div class="p-6 lg:p-8">
            ...
            @else
                <div class="text-center py-8 text-[#706f6c]">Пока нет отзывов.</div>
            @endif
        </div>
    </div>
